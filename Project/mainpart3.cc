...
// and contagion are considered, though the mode of contagion is limited.
// Nonetheless, it serves as an interesting simulation of the spread of
// an illness throughout a population 
int main() {
